        ...
        <main className='flex-1 p-6 flex gap-6'>
          <div className='flex flex-col flex-1 gap-4'>
            ...
            <p className='text-sm text-muted-foreground'>
              Lembre-se você pode utilizar variável <code className='text-violet-400 '>{'transcription'}</code> no seu prompt para adicionar o conteúdo de transcrição do vídeo selecionado
            </p>
          </div>
          <aside className='w-80 space-y-6'>
            <form className='space-y-6'>
              ...
              <div className='space-y-2'>
                ...
                placeholder='Inclua palavras-chave mencionas no vídeo separadas por vírgula (,)'
                />
